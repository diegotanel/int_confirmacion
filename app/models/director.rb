...
class Director < ActiveRecord::Base
	...
	validates :nombre_director, presence: true, length: {maximum: 70}
    validates :apellido_director, presence: true, length: {maximum: 70}
    ...
    validates :director_provincia, presence: true
    validates :director_localidad, presence: true
