...
class Actor < ActiveRecord::Base
	...
	validates :nombre_actor, presence: true, length: {maximum: 70}
    validates :apellido_actor, presence: true, length: {maximum: 70}
    ...
    validates :actor_provincia, presence: true
    validates :actor_localidad, presence: true
